...
struct UnlitPortalTextureProgram {
	UnlitPortalTextureProgram();
	~UnlitPortalTextureProgram();
...
extern Load< UnlitPortalTextureProgram > unlit_portal_texture_program;
...
extern Scene::Drawable::Pipeline unlit_portal_texture_program_pipeline;
