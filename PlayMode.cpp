...
Load< Scene > phonebank_scene(LoadTagDefault, []() -> Scene const * {
	return new Scene(data_path("portal-test.scene"), [&](Scene &scene, Scene::Transform *transform, std::string const &mesh_name){
...
Load< WalkMeshes > phonebank_walkmeshes(LoadTagDefault, []() -> WalkMeshes const * {
	WalkMeshes *ret = new WalkMeshes(data_path("portal-test.w"));
